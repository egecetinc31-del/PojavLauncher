...
import static net.kdt.aesirlaunch.fragments.ProfileEditorFragment.DELETED_PROFILE;
...
import net.kdt.aesirlaunch.fragments.ProfileEditorFragment;
import net.kdt.aesirlaunch.fragments.ProfileTypeSelectFragment;
import net.kdt.aesirlaunch.prefs.LauncherPreferences;
import net.kdt.aesirlaunch.profiles.ProfileAdapter;
import net.kdt.aesirlaunch.profiles.ProfileAdapterExtra;
